...
from .views import ProductView, CategoryView, inventory, OrderView, TestView, StockView, HealthCheckView, TaskView
...
urlpatterns =[
    ...
    path('health', HealthCheckView.HealthCheckView.as_view(), name='health_check'),
    path('task', TaskView.TaskView.as_view(), name='task'),
] 
